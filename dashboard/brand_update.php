...
$connect = mysqli_query($db_connect,$select_brand);
...
<div class="card" style="height: 360px;">
  <div class="card-header">
    <h2 class="fs-3 text-center mt-3">Update Your Brand List</h2>
  </div>
  <form action="brand_post.php" method="POST" enctype="multipart/form-data">
    <div class="card-body">
      ...
      <input type="text" class="form-control form-control-rounded" aria-describedby="..." placeholder="Name of Your Skill"name="name" value="<?= $brand['name']?>" >
      <input type="text" class="form-control form-control-rounded" aria-describedby="..." placeholder="Name of Your Skill"name="brand_id" hidden value="<?= $brand['id']?>" >
